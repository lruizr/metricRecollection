...
if social_network in network_list:
    ...
    if social_network == 'twitter':
        ...
        if version in version_list:
            ...
            print ">>> Version de la comparacion " + version
            print ">>> Valor de completitud: ", contadorFallos
    ...
    ############################################
        ...
        if version in version_list:
            ...
            mpFacebook.track(contadorFallos, "Fallos totales " + version, {"numero fallos": contadorFallos})
    ...
    ############################################
        ...
        if version in version_list:
            if(version=="master"):
                webbrowser.open_new(url_base_local + "/Master/googleplus-timeline-master/demo/GooglePlusCompletitud.html")
                sleep(3)
            elif(version=="latency"):
                webbrowser.open_new(url_base_local + "/Latency/googleplus-timeline-latency_defects/demo/GooglePlusCompletitudLatency.html")
                sleep(3)
            elif(version=="accuracy"):
                webbrowser.open_new(url_base_local + "/Accuracy/googleplus-timeline-accuracy_defects/demo/GooglePlusCompletitudAccuracy.html")
                sleep(3)
            ...
            #compruebo que el diccionario de Python contiene todas las claves del diccionario del componente
                ...
                #si es asi, cojo los values de python y del componente y los comparo
                    ...
                    if cmp(vPythonUser,v)==0:
                        ...
                        #mpGoogle.track(listaFallosUser,"Fallos " + version +" user",{"posicion":listaFallosUser, "version": version})
